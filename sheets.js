...
var COLUMNS = [
  { field: 'id', header: 'ID' },
  { field: 'sourceCity', header: 'Source City'},
  { field: 'destinationCity', header: 'Destination City'},
  { field: 'departureDate', header: 'Departure Date' },
  { field: 'arrivalDate', header: 'Arrival Date' },
  { field: 'boggieNumber', header: 'Boggie Number'},
  { field: 'wheelsCount', header: 'Wheel Count'},
  { field: 'truckNumber', header: 'Truck Number'}
